...
class Board {
    public:
        ...
        /**
         * Constructor. Creates a board with given radius, creating new Cells and inserting them into this->cells by calling createBoard(). The default start_coord and end_coord are (0, 0).
    ...
    private:
        /**
         * Creates all neccessary Cells up to the given radius and insert them into this->cells.
         */
        void create_board();
         ...
         */
        Cell* choose_neighbour(const pair<int, int>& coord, const set<pair<int, int>>& visited, double branch_prob);
