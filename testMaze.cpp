...
TEST_CASE("Cell::constructor", "[weight=1][part=cell]") {
    Cell cell({5, 7});
...
TEST_CASE("Board::distance", "[weight=1][part=board]") {
    Board board(4);
...
TEST_CASE("Board::create_board r = 0::correct number of cells created", "[weight=1][part=board]") {
    Board board(0);
    REQUIRE(board.cells.size() == 1);
}

TEST_CASE("Board::create_board r = 0::correct base board image", "[weight=1][part=board]") {
    Board board(0);
...
TEST_CASE("Board::create_board r = 1::correct number of cells created", "[weight=1][part=board]") {
    Board board(1);
    REQUIRE(board.cells.size() == 7);
}

TEST_CASE("Board::create_board r = 1::correct base board image", "[weight=1][part=board]") {
    Board board(1);
    PNG output = DrawMaze::draw_maze(board, 20, "none");
    if (writeoutputs) {
...
TEST_CASE("Board::create_board r = 4::correct number of cells created", "[weight=1][part=board]") {
    Board board(4);
    REQUIRE(board.cells.size() == 61);
}

TEST_CASE("Board::create_board r = 4::correct base board image", "[weight=1][part=board]") {
    Board board(4);
    PNG output = DrawMaze::draw_maze(board, 20, "none");
    if (writeoutputs) {
...
TEST_CASE("Board::configure_cells::is_edge", "[weight=1][part=board]") {
    Board board(2);
...
TEST_CASE("Board::link", "[weight=1][part=board]") {
    Board board(2);
...
TEST_CASE("Board::generate_maze::correct walls removed", "[weight=1][part=board]") {
    int seed = 7;
    Board board(4);
...
TEST_CASE("Board::generate_maze::correct longest path length stored", "[weight=1][part=board]") {
    int seed = 10;
    Board board(4);
    board.generate_maze({0, 0}, 0.5, seed);
...
TEST_CASE("Board::generate_maze::correct path distance from start for each cell", "[weight=1][part=board]") {
    int seed = 221;
    Board board(4);
    board.generate_maze({0, 0}, 0.5, seed);
...
TEST_CASE("Board::generate_maze::correct path distance from start for each cell, different start", "[weight=1][part=board]") {
    int seed = 221;
    Board board(4);
...
TEST_CASE("Board::solve_maze::correct solution length", "[weight=1][part=board]") {
    int seed = 10;
    Board board(4);
    board.generate_maze({0, 0}, 0.5, seed);
    board.solve_maze();
...
TEST_CASE("Board::solve_maze::correct solution length, different start", "[weight=1][part=board]") {
    int seed = 10;
    Board board(4);
...
TEST_CASE("Board::solve_maze::correct solution vector", "[weight=1][part=board]") {
    int seed = 42;
    Board board(4);
...
TEST_CASE("Board::solve_maze::correct solution vector, different start", "[weight=1][part=board]") {
    int seed = 42;
    Board board(4);
...
TEST_CASE("Board::solve_maze::correct solution image", "[weight=1][part=board]")
{
    int seed = 99;
    Board board(4);
    board.generate_maze({0, 0}, 0.5, seed);
...
TEST_CASE("Board::solve_maze::correct solution image, different start", "[weight=1][part=board]")
{
    cout << "Board::solve_maze::correct solution image, different start" << endl;
    int seed = 99;
    Board board(4);
...
TEST_CASE("Board::solve_maze::correct solution image with path colour", "[weight=1][part=board]")
{
    cout << "Board::solve_maze::correct solution image with path colour" << endl;
    int seed = 1337;
    Board board(4);
    board.generate_maze({0, 0}, 0.5, seed);
    board.solve_maze();
...
TEST_CASE("Board::solve_maze::correct solution image with path colour, different start", "[weight=1][part=board]")
{
    cout << "Board::solve_maze::correct solution image with path colour, different start" << endl;
    int seed = 1337;
    Board board(4);
